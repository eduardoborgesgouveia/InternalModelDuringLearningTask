...
{
    public partial class FormMainCópia : Form
    {
        #region Defines
        ...
        */
        ...
        private void menuTS_SessaoSalvar_Click(object sender, EventArgs e)
        {
			...
			//!!!!!!!!!!!!!!ATENÇÃO!!!!!!!!!!!!!!!
			//a parte debaixo só está comentada pq você editou
        ...
        private double getNormalizedCursorPos(double f)
        {
			...
			//acredito que será apenas esse que utilizaremos
        ...
        private void MenuConectar_Click(object sender, EventArgs e)
        {
			...
			//descomentar isso para o formMain funcionar
